...
import service.keppliveservice.receiver.KeepLiveReceivers;
import service.keppliveservice.service.KeepLiveService;
import service.keppliveservice.service.MyJobService;
...
//		    	MainActivity.this.start();
				KeepLiveUtils.jumpStartInterface(MainActivity.this);
		    }
		});
		...
		startService(i2);
		Log.i("91ysdk","version"+Build.VERSION.SDK_INT);
